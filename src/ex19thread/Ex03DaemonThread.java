...
독립쓰레드(Non Daemon Thread)
	:메인쓰레드와 working쓰레드(게발자가 정의한 쓰레드)을 일컫는 것으로
	메인쓰레드가 종료되어도 계속 실행되며, dead 상태가 되어야 실행이 종료되는
	쓰레는를 말한다. 해당 쓰레드는 main()메서드가 종료된 이후에도 계속
	실행되는 것을 볼 수 있다.
 */
