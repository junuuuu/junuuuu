...
public class E01JunsuType 
{
	...
	public static void main(String[] args) 
	{
		/*
		 ...
		 -일반적으로 CPU는 정수형 연산을 할 때 int형을 가장
		 빠르게 처리한다.
		...
		/*
		 ...
		 / 연산자는 두 정수를 나누어서 몫을 구하는 연산자이므로 결과는
		 0이 나온다.
		...
		/*
		 ...
		 -byte, short형은 게임캐릭터의 움직임이나 음원정보 등을 표현할때
		 주로 사용된다.
		...
		/*
		 ...
		 알려줘야한다. 이와 같이 대입을 위해 입력되는 숫자도 자료형을 기반으로
		 메모리에 저장되고, 이를 '리터럴'이라고 한다.
		 */
		
		//long long3 = 2200000000; 에러 발생됨.
