...
public class E07TypeCasting 
{
	...
	public static void main(String[] args) 
	{
		      ...
		      */
	  		byte b1 = 65;
	  		short s1;
	  		s1 = b1; // byte형이 short형보다 작은 자료형이므로 자동형변환됨
	  		...
	  		/*
	  		 char형(문자타입)에 byte(숫자타입)을 바로 대입할 수 없다.
	  		...
	  		/*
	  		 명시적 형변환: 큰 상자의 자룔를 작은 상자의 자료형에 할당해야할
	  		 때 사용한다. 단, 자료의 손실이 있을 수 있으므로 필요한 경우에만 
	  		 사용해야한다. 
	  		 */
	  		...
	  		System.out.printf("데이터미손실:b2=%d, s2=%d\n",
	  				b2, s2);
	  		/*
	  		 소주점 아래 부분이 버려지므로 데이터 손실이 있는 경우임. 따라서
