...
public class E04DoWhile 
{
	...
	{
		/*
		 시나리오] E03 예제의 1~10까지 더하는 수열 문제를 do~while문으로
		  	변경하여 구현하시오.
		 */
	  int sum = 0; //합의 초기화
	  int i= 1;   //반복을 위한 변수
	  do { //조건 없이 무조건 한 번은 실행함
		   sum+= i;//증가하는 변수i를 누적해서 더함
	  ...
	  /*
	   ...
	   펴균을 구해 A~F학점을 판단하여 출력하는 프로그램을 작성하시오.
	   단, 사용자가 X,x(대소문자 구분없음0를 입력하면 프로그램이 
...
//	  }
	  ...
	  Scanner scanner = new Scanner(System.in);
	   ...
	   do {
		   ...
		   99점이나 91점을 10으로 나누었을 때의 몫이 9라는 사실을 통해
		   구간을 대체하는 산술 결과를 얻을 수 있다. 
		    */
