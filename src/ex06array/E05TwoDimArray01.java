...
public class E05TwoDimArray01
{
	...
	/*
	 아래와 같이 2차원 배열을 초기화하면 세로3, 가로4인 배열이
	 ...
	 */
	 ...
	 /*
	 2차원 배열에서 "배열명.length"로 출력하면 세로 크기가 반환된다.
	  */
	 ...
	 for(int i=0 ; i<arr.length ; i++) {
		 /*
		  각 행의 가로 크기는 초기화된 상태에 따라 다를 수 있다.
		  0행은 2, 1행은 3, 2행은 4의 크기를 가지게 된다.
		  초기화가 안된 부분들은 null값이 채워지게 된다.(아무것도 없는상태)
		  */
		 ...
		 System.out.println("arr[0][1]="+ arr[0][3]); //예외발생
		/*
		 java.lang.ArrayIndexOutOfBoundsException 예외가 발생된다.
