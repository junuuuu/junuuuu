...
public class E01OneDimArray
{
	...
	public static void main(String[] args)
	{
		...
		초기값의 갯수를 통해 크기를 결정할 수 있다. 띠리사 이런
		경우 크기는 생략하도록 약속되어있다.
		...
		/*
		배열 요소의 갯수를 통해 벼열을 생성한 후 초기화까지 동시에
		진행한다. 이 경우 new를 생략할 수 있다.
		 */
		
		System.out.println("방법3 : 초기값만으로 선언");
		int[] initArr3 = {11, 13, 17, 19, 23}; //요소의 갯수를 통해 크기5로 지정됨
		int arrSum= 0;
		//요소의 갯수만큼 루프되면서 각 요소를 누적해서 다함.
