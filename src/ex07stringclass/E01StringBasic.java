...
public class E01StringBasic
{
	...
	public static void main(String[] args)
	{
		...
		String numResult = (num1==num2) ? "데이터가 같다" : "데이터가 다르다";
					System.out.println("비교결과:"+ numResult); //결과다르다
		...
		/*
		equals()메서드
			:Object클래스부터 상속받은 메서드로 실제 저장된
			문자열을 비교하도록 만들어진 메서드이다. 즉 아래는 
		...
		String 클래스의 객체생성 방법2
			:"(더블쿼테이션)을 사용한다. 이 경우 내용이 동일하다면
			같은 주소를 사용하게된다. 즉 새로운 객체를 생성하지 않는다
