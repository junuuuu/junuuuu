...
/*
 StringBuffer 클래스
 	...
 	새롭게 생성된 메모리에 문자열을 저장한다. 기존 메로리가 소멸되고
 	새로운 메모리가 생성되는 낭비를 막기 위해, 문자열의 변경이 많은
 	경우라면 StrngBuffer 클래스를 주로 사용한다. 해당 클래스는 기존
...
public class E03StringBuilderBuffer
{
	...
	public static void main(String[] args)
	{
	 ...
	 strBuf.insert(2, false); //(bolean 삽입)
     ...
     buf.append("금일은 StringBufffer공부중임")
    	.append(" 오늘은 수욜~~~^^");
     System.out.println("buf="+ buf);
     System.out.println("저장된 문자열크기:"+ buf.length());
     System.out.println("기본버퍼크기:"+ buf.capacity());
