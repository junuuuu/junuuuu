...
class FruitSeller3
{
	...
	/*
		...
		하지만 생성자는 객체 생성 시 딱 한번만 호출되고, 개발자가
		마음대로 호출할 수 없으므로 한 번 이상 초기화 되지 않음이 
		보장된다. 따라서 멤버상수는 생성자에서 초기화 할 수 있다.
	 */
...
class FruitBuyer3 
{
	...
	public void buyApple(FruitSeller3 seller, int money)//참조값(플룻셀러타입의 셀러),int money 
	{
...
public class E02FruitSalesMain5
{
	...
	public static void main(String[] args)
	{
		...
		buyer.numOfApple += 50; 	//구매자는 50가 증가하였다.
