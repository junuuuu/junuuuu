...
/*
public 클래스는 해당 java 파일을 대표하는 캘르스로 파일명과 동일해야하고
...
{	
	...
	//멤버메서드를 각각의 접근지정자를 통해 선언한다.
	/*
	동일 클래스 내에서는 private 멤버라 할 지라도 접근이 가능하다.
	...
	싶을 때는 public으로 선언된 멤버메서드를 이용해서 간접적으로 접근해야한다.
	 */
