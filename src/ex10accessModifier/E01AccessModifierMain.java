...
public class E01AccessModifierMain
{
	...
	public static void main(String[] args)
	{
		...
		publicMethod()를 통해 private int privateVar에 접근 가능
		 */
		
		/*
		동일한 패키지에 선언된 클래스이므로 import없이 객체 생성이 가능하다,
		...
		/*
		다른 패키지에 선언된 클래스이므로 객체 생성을 위해 import선언을
		해야한다. 또한 패키지가 다르면 private, default 멤버에 접근할 수 없다.
		 */
