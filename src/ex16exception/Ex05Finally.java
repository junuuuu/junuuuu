...
/*
 	...
 	:예외발생과 상관없이 try문에 진입햇을 떼 반드시 실행해야 할
 	코드가 있는 경우 기술하는 블럭이다.
...
public class Ex05Finally
{
	...
	throws 하고 있다. 하지만 이와 같은 예외는 어디서든 반드시
	예외처리해야한다.
	 */
	...
	static void tryCatchFinally() 
	{
		...
		try {
			...
			/*
			try문 진입 후 예외발생 여부에 상고나없이 해당 구문은 실행된다.
			또한 try문에서 return을 만나도 해당 구분은 실행된다.
			 */
