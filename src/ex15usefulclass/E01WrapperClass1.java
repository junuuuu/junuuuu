...
public class E01WrapperClass1
{
	...
	public static void main(String[] args)
	{
		...
		다시 언박싱을 위에 intValue()와 같은 메서드를 호출해야 한다.
		 */
	...
	/*
	JDK1.5이후 버전에서의 코딩형태
	오토박싱 혹은 오토언박싱이 지원되므로 기본자료형 변수를 선언 하는
	것과 동일하게 기술할 수 있다. 	
	 */
		Integer numObj1 = 100;
		Integer numObj2 = 200;
	...
	/*
	Wrapper클래스를 통해 진법변환이나 해당 자료형의 최대/최소값을 알 수 있다.
	 */
		...
		System.out.println("num0bj1="+ num0bj);
		System.out.println("num0bj1.toString()="+ num0bj.toString());
		System.out.println("num0bj1.hashCode()="+num0bj.hashCode());
		System.out.println(num0bj+1);
		System.out.println(num0bj.toString()+1);
