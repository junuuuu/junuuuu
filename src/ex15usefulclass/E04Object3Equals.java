...
class MyClass {
	...
	public boolean equals(Object obj) {
		...
		먼저 판단한다. instanceof 연산자는 해당 객체와 상속 관계가 있는 지를
		판단한다.
		 */
...
class Point {
	...
	/*
	객체1,2의 x,y 값을 동시에 비교해서 둘다 동일할 때 같은 객체로
	...
	public boolean equals(Object obj)
	{
		if(obj instanceof Point) {
			...
			System.out.println("다른 객체는 비교 대상이 아님");
			return false;
		}
	}
	@Override
...
public class E04Object3Equals
{
	...
	public static void main(String[] args)
	{
		...
		if(mc1==mc2) {
			...
			System.out.println("인스턴스 참조값(주소값이)이 다르다");
		} //[0] 다르다
