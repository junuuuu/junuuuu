...
public class E01WrapperClass2
{
	...
	public static void main(String[] args)
	{
		...
		/*
		문자열을 숫자로 변경할 때는 반드시 숫자형식만 기술해야 한다.
		...
		/*
		isDigit(): 인자로 전달된 문자가 숫자인지 판단한다. 숫자일떼
			true를 반환한다.
		 */
		...
		isUpperCAse(): 대문자인지 판단.
			단, 영문자가 아닌 경우 false를 반환한다.
		 */
		System.out.println("알파벳 대소문잔 판단");
		...
		/*
		시나리오] 주어진 뭄ㄴ자열 안에 몇개의 공백문자(스페이스)가 있는지
		판단하는 프로그램을 작성하시오.
