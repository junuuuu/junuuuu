...
class FruitSeller2
{
	...
	*/
	...
	/*
	초기화 메소드를 선언하여 객체 생성 후 다양한 형태의 초기화가 가능하다.
	apple_price를 상수에서 변수로 변경한 이유는 상수는 단 한번만 초기화되므로
	멤버메소드에서는 초기화 할 수 없다 멤버메서드는 개발자가 원할때 언제든지
	호출할 수 있으므로, 상수의 특성과는 맞지 않기 때문이다.
	 */
...
class FruitBuyer2 
{
	...
	public void buyApple(FruitSeller2 seller, int money)//참조값(플룻셀러타입의 셀러),int money 
	{
