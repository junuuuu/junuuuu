...
/*
 생성자(Constructor)
 -클래스를 객체화(인스터스화)할때 자동으로 호출되는 메서드
...
public class PersonConstructor
{
	...
	public PersonConstructor()	{
		...
		age = 0;
		addr = "미상";
		System.out.println("나는 기본생성자[1] 입니다");
	}
	//생성자2 : 인자생성자
	public PersonConstructor(String name) {
		...
		age = 1;
		addr = "출처불명";
		System.out.println("나는 기본생성자[2] 입니다");
	}
	//생성자3 : 인자생성자
	...
	public PersonConstructor(String _name, int age, String addr) {
		//멤버변수와 매개변수명이 다르면 this를 쓰지 않아도 된다.
		name = _name;
