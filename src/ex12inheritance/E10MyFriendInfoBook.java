...
/*
해당 프로그램에서 기능을 담당하는 클래슬르 핸들러 혹은 매니져
클래스라고 한다.
 */
class FriendInfoHandler 
{
	...
	3.정보 출력시 배열에 입력된 객체수만큼 반복하면서 각 요소를 통해
		멤버메서드를 호출한다.
	4.이때 오버라이딩된 메서드를 통해 항상 해당 객체의 정보를 출력할 수
		있다, 참조변수의 타입에 영향을 받지 않고 항상 오버라이딩된 최하위의
		메소드가 호출되기때문이다.
	 */
...
public class E10MyFriendInfoBook
{
	...
	시작점(Entry point) 정도의 의미만 가지는 게 좋다.
	 */
