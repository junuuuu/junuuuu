...
class Account {
	...
	/*
	입금처리: protected으로 선언되었으므로 상속관계에서 접근가능
	 */
	...
	//private으로 선언된 멤버변수를 외부로 반환 할 때 사용한다. (getter메서드)
...
public class E02PrivateInheritanceMain
{
	...
	public static void main(String[] args)
	{
		...
		/*
		private 멤버이므로 상속 받은 하위클래스의 참조변수를 통해서는
		접근할 수 없다. 은닉된 정보이므로 'not visible'이라는 에러메세지
		를 볼 수 있다.
		 */
		//sa.money = 10000; //접근불가.에러발생
