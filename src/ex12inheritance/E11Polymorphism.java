...
public class E11Polymorphism
{
	...
	public static void main(String[] args)
	{
			...
			//parent1.childMember =1; //접근불가->부모타입으로 자식멤버에 접근할수없다.
			...
			//자식 쪽 멤버에 접근하는 방법1 :다운캐스팅 후 접근한다.
			((Child)parent2).chilMember =1;
			...
			또한 Object클래스에 정의된 모든 메서드를 별도의 선언 없이
			사용할 수 있다.
			 */
