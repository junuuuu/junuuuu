...
class Computer{
	...
	간접 호출해야한다.
	상속관계라면 protected로 선언된 메서드로 호출할 수도 있다.
	 */
...
class NotebookComputer extends Computer {
	...
	public NotebookComputer(String name, int initCharge) {
		...
		부모클래스에서 인자생성자를 정의하였으므로 디폴트 생성자는
		만들어지지 않기 때문이다.
		 */
		super(name);
		battary = initCharge;
	...
	public void movigCal() {
		...
		//parivate 으로 선언된 멤버메서드이므로 직접 호출할 수 없다. 그래서
		//간접 호출한다. 
		//keyboardTouch();
		//calculate();
...
/*
테블릿 노트북: 컴퓨터의 기본기능인 계산기능, 휴대이용 기능, 여기에
