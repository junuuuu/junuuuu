...
//	}
	...
	public static void main(String[] args)
	{
		...
		System.out.println("getTotal(args1,agrs2)호출:"+ getTotal(10,20));
		...
		//System.out.println("getTotal(매개변수6개)호출:"+ getTotal(10,20.3));
		
		//정수타입과 실수타입까지 처리하려면 가변인자의 타입은 double로 하면 된다.
	}
