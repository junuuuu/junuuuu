...
import ex12inheritance.Box.GoldPaperBox;
import ex12inheritance.Box.PaperBox;
...
instanceof 연산자
	...
	반환한다.
	-객체간의 형변환이 되려면 반드시 두 클래스간에 상속관계가있어야 한다.
...
public class E09InstanceOf
{
	...
	전달된 매개변수를 최상위 클래스인 Box타입으로 받고 있기 때문이다.
	-Box타입으로 인자를 받게 되면 자동으로 업캐스팅(자동형변환)이 되기
