...
/*
 ...
 Java에서의 NamingRule(이름규칙)
 	...
 	-상수명 : SIMPLE_FUNC => 전체를 대문자로, 연결단어는 _언더바로 표현
 	-패키지명 : simple.func => 전체를 소문자로, 연결단어는 .점으로 표현
 */
...
public class E02MethodType01 
{
	...
	{
		//메서드 호출 시에는 메서드의 원형을 그대로 사용하면 된다.
		noParamNoReturn();
		noParamNoReturn2();
		noParamNoReturn3();
