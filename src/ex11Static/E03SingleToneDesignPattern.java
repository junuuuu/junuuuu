...
class SingleTone {
	...
	없으므로, new키워드를 통해 객체를 생성할 수 없게 된다.
	 */
	private SingleTone() {
		//기본생성자 
	}
...
public class E03SingleToneDesignPattern
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println(String.format("St2의 shareVar:%d", st2));
		System.out.println(String.format("St3의 shareVar:%d", st3));
